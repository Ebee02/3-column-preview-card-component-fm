...
function App() {
  return (
    <>
      <main className="antialiased flex flex-col items-center justify-center p-6  text-[15] bg-light-gray">
        ...
        <section className="main-section  w-[300px] md:w-[1000px] max-w-[300px] md:max-w-[1440px] grid grid-cols-1  md:grid-cols-3">
          ...
          <div className="first-container bg-bright-orange rounded-t-lg md:rounded-none md:rounded-tl-lg md:rounded-bl-lg p-6">
            ...
            <h2 className="heading text-light-gray text-4xl md:text-5xl font-semibold uppercase tracking-tight mb-5 md:mb-9">
              Sedans
            </h2>
            <p className="paragragh  text-trans-white md:text-xl md:leading-8 tracking-wider mb-8 md:mb-16">
              Choose a sedan for its affordability and excellent fuel economy.
              Ideal for cruising in the city or on your next road trip.
            </p>
            <a className="btn cursor-pointer py-3 px-6 rounded-full bg-light-gray text-bright-orange  font-medium tracking-wide">
              Learn More
            </a>
          </div>
          {/* <!-- first-container code end --> */}

          {/* <!-- second-container code start --> */}
          <div className="second-container bg-dark-cyan p-6">
            <div className="icon mb-5 md:mb-9">
              <i>
                <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
                  <g fill="none" fill-rule="evenodd">
            ...
            <button className="btn cursor-pointer py-3 px-6 rounded-full text-dark-cyan bg-light-gray font-medium tracking-wide">
              Learn More
            </button>
          </div>
          ...
          <div className="third-container bg-darker-cyan rounded-b-lg md:rounded-none md:rounded-tr-lg md:rounded-br-lg  p-6">
            ...
            <button className="btn cursor-pointer py-3 px-6 rounded-full bg-light-gray text-darker-cyan font-medium tracking-wide">
              Learn More
            </button>
          </div>
